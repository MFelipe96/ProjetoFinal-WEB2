...
class ListaPromocaoHotel extends React.Component{
    constructor(){
        super()
        this.state = {
            promocoes: null,
            hotel: "123456" // quando o login estiver pronto isso deve depender da sessão
        }
    }
    async componentDidMount(){
        const responsePromocoes = await fetch('http://localhost:8080/promocao/hotel?cnpj='+this.state.hotel);
...
export default ListaPromocaoHotel